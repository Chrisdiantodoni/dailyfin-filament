...
class CsUnitDetail extends ViewRecord implements HasTable
{

    use InteractsWithTable;
    protected string $view = 'filament.pages.cs-unit-detail';
    ...
    {
        return 'Detail Setoran Counter Service Unit';
    }
        ...
        return $schema->schema([
            ...
            Section::make('Informasi Umum')
                ->schema([
                    ...
                    TextEntry::make('unit_nominal_dtls.cash')->money('Rp.', locale: 'ID')
                        ->label('Setoran Tunai'),
                    TextEntry::make('unit_nominal_dtls.transfer')->money('Rp.', locale: 'ID')
            ...
            Actions::make([
                Action::make('confirm')
                    ...
                    ->hidden(fn($record) => $record->status != 'request' || cannot('Konfirmasi Permintaan Setoran Unit')),
                ...
                EditAction::make('Edit')
                    ->color('primary')
                    ->hidden(fn($record) => $record->status != 'reject' || can('Konfirmasi Permintaan Setoran Unit'))
                    ->outlined(),
            ])->extraAttributes([
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                \App\Models\ApprovalCsCashiersUnit::query()->where('cs_units_id', $this->record->id)
            )
            ->columns([
