...
namespace App\Filament\Resources\CounterServiceDeposits\Schemas;
...
class CounterServiceDepositForm
{
        ...
        return $schema->schema([
            ...
            Grid::make([
                ...
                ->schema([
                    ...
                    TextInput::make('service_nominal_dtls.cash')
                    ...
                    TextInput::make('service_nominal_dtls.transfer')
                        ->mask(RawJs::make('$money($input, \',\', \'.\')'))
                        ->stripCharacters(".")
                    ...
                    FileUpload::make('service_images_upload')
                        ->label('Upload Bukti Setoran (Optional)')
                        ->disk('public')
                        ->image()          // cuma gambar
                        ->multiple()       // bisa upload banyak
                        ->directory('upload/sparepart_deposit')
                        ->panelLayout('grid')
                        ->reactive()
